	...
	<table class="adminlist">
		...
		<?php foreach ($this->items as $i => $item) : ?>
			<tr class="row<?php echo $i % 2; ?>">
				<td>
					<a class="pointer" onclick="if (window.parent) window.parent.<?php echo $this->escape($function);?>('<?php echo $item->id; ?>', '<?php echo $this->escape(addslashes($item->name)); ?>', '<?php echo $this->escape($item->catid); ?>');">
				...
				<td class="center">
					<?php echo JHtml::_('jgrid.published', $item->sticky, $i, 'products.sticky_', $canChange = false);?>
				</td>
				<td class="center">
					<?php echo JHtml::_('jgrid.published', $item->state, $i, 'products.', $canChange = false);?>
				</td>
				<td class="center" nowrap="nowrap">
					<?php 
						if($item->user_post)
